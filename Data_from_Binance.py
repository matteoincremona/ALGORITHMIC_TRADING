...
# I'm using API and not the Websocket beacuse (personally) I don't need a continuous comunication with Binance
...
# data = client.get_historical_klines("ETHBUSD", Client.KLINE_INTERVAL_1DAY, "21 Feb, 2022") # up to now
